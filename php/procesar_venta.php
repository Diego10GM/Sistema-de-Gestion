...
// Iniciamos sesión para mensajes
session_start();
...
try {
    ...
    // Insertamos la venta con el nombre correcto de la columna fecha_venta
    ...
    // Redirigimos a la página de ventas (ajustamos la ruta)
    header('Location: ../ventas/ver_ventas.php');  // Ajustamos según la ubicación correcta
    exit();
